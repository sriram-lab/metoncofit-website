...
This dashboard shows the data distribution for each of the MetOncoFit tumor models.

TODO:
  * Add figures from manuscript
  * Add data table
...
app.title = 'MetOncoFit Interactive Explorer'
...
colormap = src.col.Choose_Gradient('red')

# Text describing MetOncoFit
_body = src.static.header()

# Create dynamic parts that will allow client to interact with data
_widgets = src.functions.widget(data=df)

up_heatmap = src.functions.make_struct(
                                       hmid='up-heatmap',
                                       data=up,
                                       name='up',
                                       cmap=colormap)
neut_heatmap = src.functions.make_struct(
                                         hmid='neut-heatmap',
                                         data=neut,
                                         name='neut',
                                         cmap=colormap)
down_heatmap = src.functions.make_struct(
                                         hmid='down-heatmap',
                                         data=down,
                                         name='down',
                                         cmap=colormap)
