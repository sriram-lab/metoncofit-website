...
- values (list of strings; optional): The currently selected value
...
Those keys have the following types:
  ...
  - component_name (string; optional): Holds the name of the component that is loading"""
    ...
    def __init__(self, id=Component.UNDEFINED, options=Component.UNDEFINED, values=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, key=Component.UNDEFINED, inputStyle=Component.UNDEFINED, inputClassName=Component.UNDEFINED, labelStyle=Component.UNDEFINED, labelClassName=Component.UNDEFINED, inline=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'options', 'values', 'className', 'style', 'key', 'inputStyle', 'inputClassName', 'labelStyle', 'labelClassName', 'inline', 'loading_state']
        self._type = 'Checklist'
        self._namespace = 'dash_bootstrap_components/_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'options', 'values', 'className', 'style', 'key', 'inputStyle', 'inputClassName', 'labelStyle', 'labelClassName', 'inline', 'loading_state']
